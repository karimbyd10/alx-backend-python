...
class ConversationViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        # Create a new conversation with participant IDs
...
class MessageViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if not all([sender_id, conversation_id, message_body]):
            return Response({'error': 'sender_id, conversation_id and message_body required'}, status=status.HTTP_400_BAD_REQUEST)
